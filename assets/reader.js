 ...
 * Updated for Go mdview: Chroma CSS swap instead of hljs CDN
 */
...
(function() {
  ...
  // Set theme
  function setTheme(theme, skipMermaid) {
    html.dataset.theme = theme;
    localStorage.setItem(THEME_KEY, theme);

    // Switch Chroma syntax highlighting theme
    if (chromaLight && chromaDark) {
      chromaLight.disabled = theme === 'dark';
      chromaDark.disabled = theme === 'light';
    }
  ...
  function initMobileNav() {
    ...
    if (sidebarEl && bottomSheetContent) {
      bottomSheetContent.innerHTML = sidebarEl.innerHTML;
    }
